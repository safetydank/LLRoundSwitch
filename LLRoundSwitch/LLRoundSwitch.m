...
//
//  based on DCRoundSwitch.m Created by Patrick Richards on 28/06/11.
//  MIT License.
//  http://github.com/domesticcatsoftware/DCRoundSwitch

#import "LLRoundSwitch.h"
#import "LLRoundSwitchToggleLayer.h"
#import "LLRoundSwitchOutlineLayer.h"
#import "LLRoundSwitchKnobLayer.h"

@implementation LLRoundSwitch
...
-(void) setup 
{
    ...
    toggleLayer = [[LLRoundSwitchToggleLayer alloc] initWithOnString:self.onText
	...
	outlineLayer = [LLRoundSwitchOutlineLayer layer];
	[toggleLayer addSublayer:outlineLayer];
	[outlineLayer setNeedsDisplay];
    
	knobLayer = [LLRoundSwitchKnobLayer layer];
